...
$id = $_POST['id_update'];
$sql = "SELECT * FROM mitra, kampusmengajar WHERE id_km = '$id' AND program = 'kampus_mengajar'";
    ...
    <div class="card">
        ...
        <div id="page1" class="card-body form-page active">
            <div class="mb-3 mt-3">
                ...
                <input type="text" value="<?php echo htmlspecialchars($hasil['nama_sekolah']); ?>" class="form-control" id="namakegiatan" name="namakegiatan">
            </div>
