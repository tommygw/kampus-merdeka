...
$query = "SELECT kampusmengajar.*, mitra.nama_perusahaan, mitra.foto, mitra.nama_display 
          FROM kampusmengajar 
          INNER JOIN mitra ON kampusmengajar.id_mitra = mitra.id_mitra 
          WHERE mitra.email = '$email' AND kampusmengajar.id_km = '$id_km'";
