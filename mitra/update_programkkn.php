...
$id = $_POST['id_update'];
$sql = "SELECT * FROM mitra, kkntematik WHERE id_kkn = '$id' AND program = 'kkn'";
    ...
    <div class="card">
        ...
        <div id="page1" class="card-body form-page active">
            <div class="mb-3 mt-3">
                ...
                <input type="text" value="<?php echo htmlspecialchars($hasil['nama_kegiatan']); ?>" class="form-control" id="namakegiatan" name="namakegiatan">
            </div>
            ...
            <div class="mb-3 mt-3">
                ...
                <select class="form-select" id="jeniskegiatan" name="jeniskegiatan" aria-label="Small select example">
                    <option value="kkntematik">KKN - Tematik</option>
                </select>
            </div>
            ...
            <div class="input-group mb-3 mt-3">
                ...
                <textarea class="form-control" id="desckegiatan" name="desckegiatan" aria-label="With textarea" rows="10" cols="50"><?php echo htmlspecialchars($hasil['description']); ?></textarea>
            </div>
            <div class="input-group mb-3 mt-3">
                <span class="input-group-text">Persyaratan</span>
                <textarea class="form-control" id="syaratkegiatan" name="syaratkegiatan" aria-label="With textarea" rows="10" cols="50"><?php echo htmlspecialchars($hasil['syarat']); ?></textarea>
            </div>
