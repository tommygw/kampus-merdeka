...
$query = "SELECT pmm.*, mitra.nama_display, mitra.nama_perusahaan, mitra.foto, mitra.nama_display 
          FROM pmm 
          INNER JOIN mitra ON pmm.id_mitra = mitra.id_mitra 
          WHERE mitra.email = '$email' AND pmm.id_pmm = '$id_pmm'";
