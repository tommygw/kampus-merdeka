              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?= $d['npm']; ?></div>
                  </div>
                  ...
                  <form method="POST" action="update_profile.php" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="../images/<?= $d['foto']; ?>" alt="Profile Kosong">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="nama_lengkap" type="text" class="form-control" id="nama_lengkap" placeholder="Masukan Nama Lengkap" value="<?= $d['nama']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="npm" type="text" class="form-control" id="npm" placeholder="Masukan NPM" value="<?= $d['npm']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="prodi" type="text" class="form-control" id="prodi" placeholder="Masukan Program Studi" value="<?= $d['prodi']; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="semester" type="text" class="form-control" id="semester" placeholder="Masukan Semester" value="<?= $d['semester']; ?>">
                      </div>
                    </div>
