    ...
    $sql = "SELECT id_mitra, nama_display, foto FROM mitra WHERE program = 'stupen'";
        ...
        while($row = mysqli_fetch_assoc($result)) {
            ...
            $card_html[] = '<div class="col-xxl-4 col-md-6">
                                <div class="card info-card sales-card">
                                    <div class="card-body">
                                        <h5 class="card-title">Program <span>| Studi Independent</span></h5>
                                        <div class="d-flex align-items-center">
                                            <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                                <img src="../images/' . $foto . '" alt="foto mitra" class="rounded-circle" style="width:60px; height:60px">
                                            </div>
                                            <div class="ps-3">
                                                <a href="index.php?page=stupenmitra&id_mitra='. $id_mitra .'"><h6 style="font-size: 22px;">' . $nama_display . '</h6></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
