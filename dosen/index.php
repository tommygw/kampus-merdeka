...
$query2 = "SELECT * FROM dosen WHERE email = '$email'";
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-mhs" data-bs-toggle="collapse" href="#">
        <i class="bi bi-person-lines-fill"></i><span>Data Mahasiswa</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-mhs" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="index.php?page=kegiatan">
              <i class="bi bi-circle"></i><span>List Mahasiswa</span>
            </a>
          </li>
          <li>
            <a href="index.php?page=laporan">
              <i class="bi bi-circle"></i><span>Laporan Akhir Mahasiswa</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
